...
public class PaddleOcrParser {
    ...
    private static String mapType(String value){return switch(value){case"title","doc_title","paragraph_title","section_title"->"heading";case"number","page_number","page-number"->"page-number";case"table"->"table";case"figure","image","chart"->"figure";case"formula","equation"->"formula";case"caption","figure_title","table_title"->"caption";default->"text";};}
