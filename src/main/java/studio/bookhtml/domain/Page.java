...
public record Page(int pageNumber, double width, double height, String status, String provider,
                   ...
                   List<Block> sourceRecords, Integer revision, java.util.UUID lastCommitId) {
    public Page(int pageNumber,double width,double height,String status,String provider,List<Block>blocks,List<String>warnings,boolean reviewed,String error,List<Block>sourceRecords,Integer revision){this(pageNumber,width,height,status,provider,blocks,warnings,reviewed,error,sourceRecords,revision,null);}
