...
export const api = {
  ...
  books: () => request('/books'),
  bookMetadata: id => request(`/books/${encodeURIComponent(id)}/metadata`),
  ...
  pageProgress: (id, n, signal) => request(`/books/${encodeURIComponent(id)}/pages/${n}/progress`, signal ? { signal } : {}, 10000),
