...
EXPECTED_TREE = '1a1d85f6e3002b1dbd8c790f382080edfd6efba1'
...
followup = stage / 'followup.patch'
if hashlib.sha256(followup.read_bytes()).hexdigest() != '39a5cc04a387e3ae3ca5eadfa67a79adb037f93113ebfa5e586e77d5d9dbd789':
